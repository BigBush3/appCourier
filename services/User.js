...
export const getIncomeMonth = (_host, _sm, _em) => {
  console.log(
    "http://" + _host + "/ibm/users/stat/income/month/" + _sm + "/" + _em
  );
  return fetch(
    "http://" + _host + "/ibm/users/stat/income/month/" + _sm + "/" + _em,
    {
...
export const getUserAccess = (_host, _userId) => {
  console.log("http://" + _host + "/ibm/users/access/" + _userId);
  return fetch("http://" + _host + "/ibm/users/access/" + _userId, {
    method: "GET",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
...
export const getAllDeliverymen = (_host) => {
  console.log("http://" + _host + "/ibm/users/allDeliveryman/");
  return fetch("http://" + _host + "/ibm/users/allDeliveryman/", {
    method: "GET",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
