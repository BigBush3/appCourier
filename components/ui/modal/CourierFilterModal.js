...
export default class CourierFilterModal extends React.Component {
  constructor(props) {
    super(props);
  }
      ...
      >
        <View style={styles.modal}>
          ...
          <View style={styles.modalInner}>
            <Text style={styles.subtitleText}>Выберите курьера</Text>
            <ScrollView style={styles.radio}>
              {/* Опция "Все курьеры" */}
              <TouchableOpacity
                onPress={() => {
                  this.props.onClose();
                  this.props.onSelectCourier({ USERSID: "-1", NAME: "Все курьеры" });
                }}
                style={[styles.option]}
              >
                <View style={styles.courierInfo}>
                  <Text style={styles.courierName}>Все курьеры</Text>
                </View>
                <View style={styles.radioCheck}>
                  {this.props.selectedCourierId === "-1" ? (
